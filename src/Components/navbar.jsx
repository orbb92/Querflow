...
export default class navbar extends Component {
    ...
    render() {
        return (
            ...
            <Navbar  expand="sm">
                <Navbar.Brand > <img style={{ height: "14vh", float: "left", position: 'absolute', top: -25 }} src="https://i.ibb.co/4J6fJcy/unnamed.png" alt="pic"></img></Navbar.Brand>                    <Navbar.Toggle aria-controls="basic-navbar-nav" />
