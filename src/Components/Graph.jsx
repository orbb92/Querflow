    ...
    render() {
        ...
        return (
            <div style={{}} >
                ...
                <   div style={{ display: 'flex', flexDirection: 'row', position: 'relative', top: -10 }}>
                    <div style={{ width: '20vw', height: '80vh', paddingLeft: '10px', zIndex: this.state.Tech.length === 0 ? -5 : 1 }}>
        ...
        <Carousel.Item >
                            <div id='chart' style={{ height: "80vh", width: "80vw", display: "flex", flexWrap: 'wrap' }}>
                                <div id='leftChart' style={{ width: '60%', boxShadow: '0 0px 5px', margin: '2px', padding: 0 }}>
                                ...
                                <div id='rightChart' style={{ width: '38%', display: "flex", flexDirection: 'column', padding: 0 }}>
                                    {this.state.ChartArray.rightChart.map((item, index) => {
                                        return <div style={{ display: 'flex', boxShadow: '0 0px 5px', margin: '2px' }}> <GraphComp height={'40vh'} width={'100%'} type={item} RawData={this.state.RawData} data={this.state.Data} number={index} kind={'smallChart'}></GraphComp></div>
