        ...
        return (
            <div>
                ...
                <div style={{ position: 'relative', display: "flex", justifyContent: "center", alignItems: "center", paddingTop: '10px' }}>
                    <Wrapper id='map' style={{ height: '70vh', zIndex: 1, width: '98vw', boxShadow: '0 0px 5px' }}></Wrapper>
                ...
                <div ref={this.section} style={{ width: '98vw', boxShadow: '0 0px 5px', margin: 'auto', display: 'flex', flexDirection: 'row', paddingTop: 0 }}>
                    <div style={{ width: '60%', display: 'flex' }}>
                        <TableComp className='tbl' data={this.props.Layer} tech={this.state.TechResearch} addMarker={this.addMarkers}  ></TableComp>
                    </div>
                    <div className='ChountryChart' style={{ display: 'flex', width: '40%' }}>
